...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1"
  ...
  <!-- document head -->
    ...
    <script type="text/javascript">
      <includeAttribute name="src" item="scriptPath"><parameter>script_loc.js</parameter></includeAttribute>
      <xsl:text> </xsl:text>
    </script>
    <script type="text/javascript">
  ...
  <xsl:template match="elements" mode="member">
    ...
    <xsl:if test="element/apidata[@subgroup='constructor']">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subgroup='constructor']][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="element/apidata[@subgroup='method' and not(@subsubgroup)]">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subgroup='method' and not(@subsubgroup)]][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="element/apidata[@subsubgroup='operator']">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subsubgroup='operator']][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="element/apidata[@subgroup='field']">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subgroup='field']][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="element/apidata[@subgroup='property' and not(@subsubgroup)]">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subgroup='property' and not(@subsubgroup)]][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
    ...
    <xsl:if test="element/apidata[@subgroup='event' and not(@subsubgroup)]">
      <xsl:call-template name="memberlistSection">
        ...
        <xsl:with-param name="members" select="element[apidata[@subgroup='event' and not(@subsubgroup)]][.//memberdata[@visibility='public' or @visibility='family' or @visibility='family or assembly' or @visibility='assembly']]" />
      </xsl:call-template>
    </xsl:if>
