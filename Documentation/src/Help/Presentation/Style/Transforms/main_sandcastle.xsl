      ...
      <script type="text/javascript">
        <xsl:text>
          var feedb = new FeedBack(
              '</xsl:text><include item="feedback_alias" /><xsl:text>', 
              '</xsl:text><include item="feedback_product" /><xsl:text>',
              '</xsl:text><include item="feedback_deliverable" /><xsl:text>', 
              '</xsl:text><include item="feedback_fileVersion" /><xsl:text>', 
              '</xsl:text><include item="feedback_topicVersion" /><xsl:text>',
              fb,
              '</xsl:text><include item="feedback_body" /><xsl:text>');
              
            feedb.HeadFeedBack(headfb,
              '</xsl:text><include item="fb_headerFeedBack" /><xsl:text>',
              '</xsl:text><include item="feedback_ratings" /><xsl:text>');
